...
| Signal | Cooldown, Commission % | Throttle + journal cost. |
...
Top block = current state (position, open P&L, trend, RS, volatility regime, squeeze, extension). Lower block = the trade journal accumulated over the loaded history.
